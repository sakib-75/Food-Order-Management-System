...
<body>
    ...
    <section class="bg-7 h-500x main-slider pos-relative" style=" background-image: url('images/slider_5_1920_600.jpg');">
        <header>
            <div class="container">
                    ...
                    <div class="panel panel-default" id="select">
                        ...
                        <div class="panel-body">
                            <div class="image-body">
                                <a href='singlefood.php?productname=<?php echo $foodname?>'> <img src="Admin/<?php if(empty($pfrow['photo'])){echo "upload/noimage.jpg";} else{echo $pfrow['photo'];} ?>" height="225px;" width="100%"></a>
                            </div>
                        </div>
            ...
            <div id="<?php echo $trow['catname']; ?>" class="tab-pane fade" style="margin-top:20px;">
                ...
                <div class="col-md-3">
                    <div class="panel panel-default" id="select">
                        ...
                        <div class="panel-body">
                            <div class="image-body">
                                <a href='singlefood.php?productname=<?php echo $foodname?>'><img src="Admin/<?php if($prow['photo']==''){echo "upload/noimage.jpg";} else{echo $prow['photo'];} ?>" height="225px;" width="100%"></a>
                            </div>
                        </div>
                        <div class="panel-footer text-center">
                            <h5> &#2547; <?php echo number_format($final_price); ?> <?php echo $badge;?></h5>
