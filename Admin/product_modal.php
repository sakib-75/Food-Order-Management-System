                ...
                <div class="container-fluid">
                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-md-9">
                                <input type="text" class="form-control" value="<?php echo $row['offer_title']; ?>" name="offer_title">
                            </div>
                        </div>
                    </div>
					<div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-md-9">
                                <input type="text" class="form-control" value="<?php echo $row['offer']; ?>" name="offer">
                            </div>
                        </div>
                    </div>
					<div class="form-group">
