                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
							    <h3 class="text-center"> Change Password <i class="fa fa-lock" aria-hidden="true"></i></h3>
							</div>
                           
							<form class="example" name="changepassword" method="post" onsubmit="return checkpass();" action="">
